...
- **Consensus member** — a `(skill, params, expected_artifact, intrinsic_quality_key)` tuple; runs as a deterministic skill subprocess, **not** a CellClaw-style LLM sub-agent. _Avoid_: "sub-agent".
