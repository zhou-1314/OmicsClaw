...
point. All three Surfaces dispatch into the same engine entry
``core.llm_tool_loop``; the only differences are how they accept input
(IM message / HTTP request / terminal) and how they stream output.
