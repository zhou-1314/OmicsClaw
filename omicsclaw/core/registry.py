...
_HARDCODED_SKILLS: dict[str, dict[str, Any]] = {
    ...
    "bulkrna-alignment": {
        "domain": "bulkrna",
        "alias": "bulkrna-alignment",
        "legacy_aliases": ["bulk-align"],
        "script": SKILLS_DIR / "bulkrna" / "bulkrna-alignment" / "bulkrna_alignment.py",
        "demo_args": ["--demo"],
        "description": "Count matrix QC — library size, gene detection rates, sample correlation",
        "allowed_extra_flags": set(),
        "saves_h5ad": False,
    },
    "bulkrna-de": {
