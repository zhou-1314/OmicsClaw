...
<!-- ORCH-INTRO-START -->
- **Without it**: Users must know exact skill names and CLI flags across 96 skills in 8 domains
<!-- ORCH-INTRO-END -->

## Supported Domains

<!-- ORCH-DOMAINS-START -->
OmicsClaw currently supports **96 skills across 8 domains**:

1. **Spatial Transcriptomics** (19 skills) - `.h5ad`, `.h5`, `.zarr`, `.loom`
2. **Single-Cell Omics** (34 skills) - `.h5ad`, `.h5`, `.loom`, `.mtx`
...
6. **Bulk RNA-seq** (14 skills) - `.csv`, `.tsv`, `.fastq`
7. **Orchestrator** (2 skills) - `*` (all types)
8. **Literature** (1 skills) - `PDF`, `DOI`, `PubMed`, `URL`, text
<!-- ORCH-DOMAINS-END -->

<!-- Note: counts above are regenerated by scripts/generate_orchestrator_counts.py -->
...
<!-- ORCH-FOOTER-START -->
- All 96 skills across 8 domains are accessible through this single interface
<!-- ORCH-FOOTER-END -->
