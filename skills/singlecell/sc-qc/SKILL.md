...
```bash
# Basic usage
python skills/singlecell/sc-qc/sc_qc.py --input <data.h5ad> --output <dir>

# With demo data
python skills/singlecell/sc-qc/sc_qc.py --demo --output /tmp/qc_demo

# Specify species
python skills/singlecell/sc-qc/sc_qc.py --input <data.h5ad> --output <dir> --species mouse
