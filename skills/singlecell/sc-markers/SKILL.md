...
```bash
# Basic usage
python skills/singlecell/sc-markers/sc_markers.py --input <data.h5ad> --output <dir> --groupby leiden

# With specific method
python skills/singlecell/sc-markers/sc_markers.py --input <data.h5ad> --output <dir> \
