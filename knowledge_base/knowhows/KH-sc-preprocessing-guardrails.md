...
- **Standardize external inputs first**: if count provenance is unclear, recommend `sc-standardize-input` before preprocessing so later count-vs-normalized assumptions are explicit.
