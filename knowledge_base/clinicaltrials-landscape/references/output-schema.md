...
Cross-tabulation with mechanisms as rows, phases as columns, and trial counts as values.
...
Markdown version with the same 24 sections. Useful for embedding in other documents or rendering in Biomni.
